          ...
          SizedBox(
            ...
            child: DropdownButtonFormField<String>(
              ...
              onChanged: (newValue) {
                ...
                createEventProvider.updateDurationFrom(
                  getFormattedTime(_selectedTime.toString(), _selectedTitle ?? 'AM')
                );
              },
            ...
            child: DropdownButtonFormField<String>(
              ...
              onChanged: (newValue) {
                ...
                if (_selectedTime != null) {
                  createEventProvider.updateDurationFrom(
                    getFormattedTime(_selectedTime.toString(), newValue ?? 'AM')
                  );
                }
              },
              decoration: InputDecoration(
            ...
            SizedBox(
              ...
              child: DropdownButtonFormField<String>(
                ...
                onChanged: (newValue) {
                  ...
                  createEventProvider.updateDurationTo(
                    getFormattedTime(_selectedTime.toString(), _selectedTitle ?? 'AM')
                  );
                },
                decoration: InputDecoration(
