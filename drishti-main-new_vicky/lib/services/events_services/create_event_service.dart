  ...
  Future createEvent(
    ...
    try {
      ...
      if (model.title == null || !_validateTitleEnum(model.title!)) {
        throw Exception(
            "Invalid title. Must be one of: Sudarshan Kriya, Medha Yoga, Utkarsh Yoga, Sahaj Samadh, Ganesh Homa, Durga Puja");
      }
      ...
      if (model.aol == null || !_validateAOLEnum(model.aol!)) {
        throw Exception(
            "Invalid AOL type. Must be one of: event, course, follow-up");
      }
      ...
      // Add meetingLink regardless of mode if it's not empty
